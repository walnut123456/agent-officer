...
public class CodeInterpreterTool implements BaseTool {
    ...
    public Object execute(Object input) {
        try {
            ReactorConfig reactorConfig = requireReactorConfig();
            if (StringUtils.isEmpty(reactorConfig.getCodeInterpreterUrl())) {
                return buildFailurePayload("code_interpreter工具未配置服务地址，请设置 autobots.autoagent.code_interpreter_url");
            }
