...
from hermes_officer.util.file_util import (
    _is_local_file_reference,
    _normalize_local_path,
    upload_file_by_path,
)
from hermes_officer.util.llm_util import (
...
async def _upload_generated_images(
    ...
    with tempfile.TemporaryDirectory(prefix="hermes-image-generation-") as temp_dir:
