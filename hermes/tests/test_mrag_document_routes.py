...
from hermes_officer.tool.mrag.api.routes import document as document_module
from hermes_officer.tool.mrag.enums.source_type_enums import SourceTypeEnum
from hermes_officer.tool.mrag.enums.task_status_enums import TaskStatusEnum
from hermes_officer.tool.mrag.storage.models.kb_doc_model import (
    CANONICAL_FULL_TEXT_CHUNK_TYPE,
    KBDocModel,
)
from hermes_officer.tool.mrag.storage.models.kb_file_model import KBFileModel
        ...
        with tempfile.TemporaryDirectory(prefix="mrag-web-test-") as temp_dir:
            ...
            with patch.object(document_module.tempfile, "gettempdir", return_value=temp_dir):
                with patch.object(document_module, "get_kb_file_store", return_value=kb_file_store):
                    with patch("hermes_officer.tool.mrag.utils.crawl_utils.crawl", return_value="# 网页标题\n\n正文"):
