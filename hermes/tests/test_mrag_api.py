...
from hermes_officer.tool.mrag.storage.qdrant_vector_store import QdrantVectorStore
...
class MragApiTest(unittest.TestCase):
    ...
    def test_should_build_mrag_qdrant_client_from_shared_config(self):
        with patch.dict(
            ...
            with patch("hermes_officer.tool.mrag.storage.qdrant_vector_store.build_qdrant_client") as build_client:
