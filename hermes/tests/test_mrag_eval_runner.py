...
class MragEvalRunnerTest(unittest.TestCase):
    ...
    def test_should_export_deduplicated_manifest_records_from_payloads(self):
        from hermes_officer.tool.mrag.eval.dataset import build_manifest_records
    ...
    def test_should_load_and_dump_jsonl_datasets(self):
        from hermes_officer.tool.mrag.eval.dataset import (
            dump_jsonl_records,
            load_qrels,
            load_queries,
        )
    ...
    def test_should_compute_fixed_stage_recall_for_retrieval_required_queries_only(self):
        from hermes_officer.tool.mrag.eval.metrics import compute_recall_report
        from hermes_officer.tool.mrag.eval.models import EvalQrel, EvalQuery
        from hermes_officer.tool.mrag.eval.trace import RetrievalTrace, RetrievalTraceHit, RetrievalTraceRound, RetrievalTraceStage
    ...
    def test_should_run_recall_from_dataset_directory(self):
        ...
        from hermes_officer.tool.mrag.eval.models import EvalQrel, EvalQuery
        from hermes_officer.tool.mrag.eval.runner import run_recall_evaluation
