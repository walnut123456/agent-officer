...
from hermes_officer.tool.search_component.search_engine import DDGSearch, MixSearch, SearchBase


class SearchEngineIntegrationTest(unittest.IsolatedAsyncioTestCase):
    @patch("hermes_officer.tool.search_component.search_engine.DDGS")
