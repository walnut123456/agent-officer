...
from hermes_officer.util.llm_util import resolve_openai_compat_env
...
class DeepSearchLlmConfigTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_query_decompose_should_forward_deepsearch_gateway_to_both_llm_calls(self):
        ...
        with patch.dict(
            ...
            "hermes_officer.tool.search_component.query_process.ask_llm",
            new=fake_ask_llm,
        ):
    ...
    async def test_search_reasoning_should_forward_deepsearch_gateway(self):
        ...
        with patch.dict(
            ...
            "hermes_officer.tool.search_component.reasoning.ask_llm",
            new=fake_ask_llm,
        ):
    ...
    async def test_answer_question_should_forward_deepsearch_gateway(self):
        ...
        with patch.dict(
            ...
            "hermes_officer.tool.search_component.answer.ask_llm",
            new=fake_ask_llm,
        ):
            answer = []
