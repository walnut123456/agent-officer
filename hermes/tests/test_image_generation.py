...
from hermes_officer.tool.image_generation import (
    DEFAULT_IMAGE_MODEL,
...
class ImageGenerationToolTest(unittest.TestCase):
    ...
    def test_should_reuse_legacy_dashscope_image_credentials(self):
        with patch.dict(
            "os.environ",
            {
                "IMAGE_GENERATION_BASE_URL": "",
                "IMAGE_GENERATION_API_KEY": "",
                "DASHSCOPE_API_BASE": "https://dashscope.example.com",
                "DASHSCOPE_API_KEY": "dashscope-key",
            },
            clear=True,
        ):
            self.assertEqual("https://dashscope.example.com", _resolve_base_url())
            self.assertEqual("dashscope-key", _resolve_api_key())
