...
from hermes_officer.tool.mrag.eval.cli import export_manifest, main, recall_dataset
from hermes_officer.tool.mrag.eval.dataset import dump_jsonl_records
from hermes_officer.tool.mrag.eval.models import EvalQrel, EvalQuery
from hermes_officer.tool.mrag.eval.trace import RetrievalTrace, RetrievalTraceStage
...
class MragEvalCliTest(unittest.TestCase):
    ...
    def test_should_export_manifest_from_vector_store_payloads(self):
        ...
        with tempfile.TemporaryDirectory(prefix="mrag-cli-export-") as temp_dir:
            ...
            with patch("hermes_officer.tool.mrag.eval.cli.VectorStore", return_value=fake_store):
    ...
    def test_should_run_recall_dataset_with_agent_trace_collector(self):
        with tempfile.TemporaryDirectory(prefix="mrag-cli-recall-") as temp_dir:
            ...
            with patch("hermes_officer.tool.mrag.eval.cli.build_mrag_agent", return_value=fake_agent):
    ...
    def test_should_print_json_for_main_subcommands(self):
        with tempfile.TemporaryDirectory(prefix="mrag-cli-main-") as temp_dir:
            ...
            with patch("hermes_officer.tool.mrag.eval.cli.VectorStore", return_value=fake_store), patch(
                "hermes_officer.tool.mrag.eval.cli.build_mrag_agent",
