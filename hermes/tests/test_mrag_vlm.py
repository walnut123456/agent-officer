...
from hermes_officer.tool.mrag.generation.vlm import VLLMClient
from hermes_officer.tool.mrag.utils.caption_utils import generate_caption
from hermes_officer.tool.mrag.utils.ocr_utils import VLMOCR, get_ocr_model
...
class VLMClientConfigTest(unittest.TestCase):
    ...
    def test_should_read_vlm_env_and_normalize_base_url(self):
        ...
        with patch.dict(
            ...
            with patch("hermes_officer.tool.mrag.generation.vlm.OpenAI", side_effect=factory):
                client = VLLMClient()
