...
max应该是定时计算的全库的max快照
其实我们跟饱和式压缩也对比了下，热度取了10,100,1000,10000的值， M = 1000->10000  
发现10-100 log-max更能保存差异，1000-10000 log-max已经被全部截断为1，饱和式压缩则保留了差异，但也已经极小，综合下来我们选择了方案1，方案1其实在热度这种长尾上log+max是更常见且更直觉的做法，因为是线性，更直观
# Hermes Officer
